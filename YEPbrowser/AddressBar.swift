...
class AddressBar: UIView, UITextFieldDelegate {
	...
	@objc var settingButton: UIButton?
    ...
    override init(frame: CGRect) {
        ...
        backButton = UIButton().then { [unowned self] in
            ...
            $0.setTitleColor(self.overrideUserInterfaceStyle == .dark ? .white : .darkGray, for: .normal)
        ...
        settingButton = UIButton().then { [unowned self] in
            $0.setImage(UIImage(named: "setting")?.withRenderingMode(.alwaysTemplate), for: .normal)
            $0.tintColor = self.overrideUserInterfaceStyle == .dark ? .white : .darkGray
        ...
        refreshButton = UIButton(frame: CGRect(x: -5, y: 0, width: 12.5, height: 15)).then {
            $0.setImage(UIImage(named: "refresh")?.withRenderingMode(.alwaysTemplate), for: .normal)
            $0.tintColor = .gray
